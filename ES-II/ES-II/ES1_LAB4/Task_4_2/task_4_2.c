/* Lab_04_Task_4.2_Binary Counter.uvprojx
-----------------------------------------------------------------------
Implement a 4-bit binary counter using 4 external LEDs and a pushbutton 
interfaced at any GPIO port. Each time the interfaced pushbutton is pressed, 
the counter should increment by one and display the result in binary on the
LEDs. The counter must overflow on reaching maximum value.
-----------------------------------------------------------------------
...
int main ()
{
	...
	while(1)
	{
		if(count==0)  // value in binary(0000)
		{	
		...
		if(count==1)      // value in binary(0001)
		{
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
		}
		if(count==2)		// value in binary(0010)
		{
			GPIO_PORTB_DATA_1_R &= ~GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R |= GPIO_PORTB_PIN2;
		}
		if(count==3)		// value in binary(0011)
		{
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R |= GPIO_PORTB_PIN2;
		}
		if(count==4)		// value in binary(0100)
		{
			GPIO_PORTB_DATA_1_R &= ~GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R &= ~GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R |= GPIO_PORTB_PIN3;
		}
		if(count==5)		// value in binary(0101)
		{
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R &= ~GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R |= GPIO_PORTB_PIN3;
		}
		if(count==6)		// value in binary(0110)
		{
			GPIO_PORTB_DATA_1_R &= ~GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R |= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R |= GPIO_PORTB_PIN3;
		}
		if(count==7)		// value in binary(0111)
		{
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R |= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R |= GPIO_PORTB_PIN3;
		}
		if(count==8)		// value in binary(1000)
		{
			GPIO_PORTB_DATA_1_R &= ~GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R &= ~GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R &= ~GPIO_PORTB_PIN3;
		...
		if(count==9)		// value in binary(1001)
		{
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R &= ~GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R &= ~GPIO_PORTB_PIN3;
		...
		if(count==10)		// value in binary(1010)
		{
			GPIO_PORTB_DATA_1_R &= ~GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R |= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R &= ~GPIO_PORTB_PIN3;
		...
		if(count==11)		// value in binary(1011)
		{
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R |= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R &= ~GPIO_PORTB_PIN3;
		...
		if(count==12)		// value in binary(1100)
		{
			GPIO_PORTB_DATA_1_R &= ~GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R &= ~GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R |= GPIO_PORTB_PIN3;
		...
		if(count==13)		// value in binary(1101)
		{
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R &= ~GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R |= GPIO_PORTB_PIN3;
		...
		if(count==14)		// value in binary(1110)
		{
			GPIO_PORTB_DATA_1_R &= ~GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R |= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R |= GPIO_PORTB_PIN3;
		...
		if(count==15)		// value in binary(1111)
		{
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R |= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R |= GPIO_PORTB_PIN3;
		...
		if(count==16)  // overflow returns to 0000
		{ GPIO_PORTB_DATA_0_R &= GPIO_PORTB_PIN0;
			GPIO_PORTB_DATA_1_R &= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R &= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R &= GPIO_PORTB_PIN3;
		...
		if(count==17)  // overflow returns to 0000
		{ GPIO_PORTB_DATA_0_R |= GPIO_PORTB_PIN0;
			GPIO_PORTB_DATA_1_R &= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R &= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R &= GPIO_PORTB_PIN3;
			GPIO_PORTB_DATA_4_R |= GPIO_PORTB_PIN4;}
		if(count==18)  // overflow returns to 0000
		{ GPIO_PORTB_DATA_0_R &= GPIO_PORTB_PIN0;
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R &= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R &= GPIO_PORTB_PIN3;
			GPIO_PORTB_DATA_4_R |= GPIO_PORTB_PIN4;}
		if(count==19)  // overflow returns to 0000
		{ GPIO_PORTB_DATA_0_R |= GPIO_PORTB_PIN0;
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R &= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R &= GPIO_PORTB_PIN3;
			GPIO_PORTB_DATA_4_R |= GPIO_PORTB_PIN4;}
		if(count==20)  // overflow returns to 0000
		{ GPIO_PORTB_DATA_0_R &= GPIO_PORTB_PIN0;
			GPIO_PORTB_DATA_1_R &= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R |= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R &= GPIO_PORTB_PIN3;
			GPIO_PORTB_DATA_4_R |= GPIO_PORTB_PIN4;}
		if(count==21)  // overflow returns to 0000
		{ GPIO_PORTB_DATA_0_R |= GPIO_PORTB_PIN0;
			GPIO_PORTB_DATA_1_R &= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R |= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R &= GPIO_PORTB_PIN3;
			GPIO_PORTB_DATA_4_R |= GPIO_PORTB_PIN4;}
		if(count==22)  // overflow returns to 0000
		{ GPIO_PORTB_DATA_0_R &= GPIO_PORTB_PIN0;
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R |= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R &= GPIO_PORTB_PIN3;
			GPIO_PORTB_DATA_4_R |= GPIO_PORTB_PIN4;}
		if(count==23)  // overflow returns to 0000
		{ GPIO_PORTB_DATA_0_R |= GPIO_PORTB_PIN0;
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R |= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R &= GPIO_PORTB_PIN3;
			GPIO_PORTB_DATA_4_R |= GPIO_PORTB_PIN4;}
		if(count==24)  // overflow returns to 0000
		{ GPIO_PORTB_DATA_0_R &= GPIO_PORTB_PIN0;
			GPIO_PORTB_DATA_1_R &= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R &= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R |= GPIO_PORTB_PIN3;
			GPIO_PORTB_DATA_4_R |= GPIO_PORTB_PIN4;}
		if(count==25)  // overflow returns to 0000
		{ GPIO_PORTB_DATA_0_R |= GPIO_PORTB_PIN0;
			GPIO_PORTB_DATA_1_R &= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R &= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R |= GPIO_PORTB_PIN3;
			GPIO_PORTB_DATA_4_R |= GPIO_PORTB_PIN4;}
		if(count==26)  // overflow returns to 0000
		{ GPIO_PORTB_DATA_0_R &= GPIO_PORTB_PIN0;
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R &= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R |= GPIO_PORTB_PIN3;
			GPIO_PORTB_DATA_4_R |= GPIO_PORTB_PIN4;}
		if(count==27)  // overflow returns to 0000
		{ GPIO_PORTB_DATA_0_R |= GPIO_PORTB_PIN0;
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R &= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R |= GPIO_PORTB_PIN3;
			GPIO_PORTB_DATA_4_R |= GPIO_PORTB_PIN4;}
		if(count==28)  // overflow returns to 0000
		{ GPIO_PORTB_DATA_0_R &= GPIO_PORTB_PIN0;
			GPIO_PORTB_DATA_1_R &= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R |= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R |= GPIO_PORTB_PIN3;
			GPIO_PORTB_DATA_4_R |= GPIO_PORTB_PIN4;}
			if(count==29)  // overflow returns to 0000
		{ GPIO_PORTB_DATA_0_R |= GPIO_PORTB_PIN0;
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R &= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R |= GPIO_PORTB_PIN3;
			GPIO_PORTB_DATA_4_R |= GPIO_PORTB_PIN4;}
		if(count==30)  // overflow returns to 0000
		{ GPIO_PORTB_DATA_0_R &= GPIO_PORTB_PIN0;
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R |= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R |= GPIO_PORTB_PIN3;
			GPIO_PORTB_DATA_4_R |= GPIO_PORTB_PIN4;}
			if(count==31)  // overflow returns to 0000
		{ GPIO_PORTB_DATA_0_R |= GPIO_PORTB_PIN0;
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R |= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R |= GPIO_PORTB_PIN3;
			GPIO_PORTB_DATA_4_R |= GPIO_PORTB_PIN4;}
		if(count==32)  // overflow returns to 0000
		{ GPIO_PORTB_DATA_0_R &= GPIO_PORTB_PIN0;
			GPIO_PORTB_DATA_1_R |= GPIO_PORTB_PIN1;
			GPIO_PORTB_DATA_2_R &= GPIO_PORTB_PIN2;
			GPIO_PORTB_DATA_3_R |= GPIO_PORTB_PIN3;
