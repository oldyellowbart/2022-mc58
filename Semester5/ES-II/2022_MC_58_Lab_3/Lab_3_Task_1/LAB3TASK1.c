/*Task 3.1: Modify the Example_01 program such that LED blinks at double the
current frequency. You are not allowed to change the value of RELOAD Register.
Hint: you need to read CURRENT register for value equal to half the RELOAD value
and toggle LED (in addition to LED toggle when CURRENT turns to zero).
-----------------------------------------------------------------------
